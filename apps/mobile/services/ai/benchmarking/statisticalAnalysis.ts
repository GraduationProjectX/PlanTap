 ...
 *
 * truePositives Count of correctly identified relevant items
 * falsePositives Count of incorrectly identified relevant items
 * falseNegatives Count of missed relevant items
 */
